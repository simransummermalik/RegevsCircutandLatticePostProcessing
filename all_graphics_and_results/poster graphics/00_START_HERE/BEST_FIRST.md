# Best first: a simple poster, not a wall of plots

The library is intentionally oversized so the team can veto options. A clear final poster should use about **eight** main visuals.
...
6. **Six-cell certificate-gap heatmap** — the compact primary result.
7. **Whole-`N` cluster-bootstrap forest plot** — the statistical evidence behind the pass decisions.
8. **QFT-only resource panel plus scope fence** — states the savings and their exact limitation together.
...
- `14_SUPPLEMENTAL_VETO_OPTIONS/S03_main_six_cell_certificate_gap.*`
- `14_SUPPLEMENTAL_VETO_OPTIONS/S04_primary_cluster_forest_plot.*`
- `14_SUPPLEMENTAL_VETO_OPTIONS/S05_M32_qft_only_resources.*`
- `14_SUPPLEMENTAL_VETO_OPTIONS/S14_scope_fence.*`

## What not to headline

- The earlier diversity result: it is background/negative evidence, not the final contribution.
- The quotient-deflation study: it did not establish the desired improvement.
